            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input name="tgl_terima" class="form-control" value="{{ old('tgl_terima') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="tgl_surat" class="form-control" value="{{ old('tgl_surat') }}">
                        <div class="text-danger">
                            @error('tgl_surat')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group">
                        <label>Perihal</label>
                        <input name="perihal" class="form-control" value="{{ old('perihal') }}">
                        <div class="text-danger">
                            @error('perihal')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input name="file_surat" class="form-control" value="{{ old('file_surat') }}">
                        <div class="text-danger">
                            @error('file_surat')
                                {{ $message }}
                            @enderror
